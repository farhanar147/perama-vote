        ...
        <div class="wrapper">
            ...
            <div class="col-md-12">
                ...
                <?php  if (session()->getFlashdata('pesan')) {  ?>
                 ...
                 <?php } ;?>
                <a href="/admin/create_presma" class="btn btn-info">Tambah Data</a> 
                <br>
                <br>     
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>#</td>
                        <td><img src="/img/<?= $key['foto']; ?>" alt="" class="sampul"></td>
                        <td><?= $key['nama']; ?></td>
                        <td><?= $key['nim']; ?></td>
                        ...
                        <td><?= $key['visi']; ?></td>
                        <td>
                            <a href="/admin/delete_presma/<?= $key['id_presma']; ?>" onclick="return confirm('apakah anda yakin?');" class="btn btn-danger mx-2" ><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                        </td>
                    </tr>
                    </tbody>
                    <?php }  ?>
