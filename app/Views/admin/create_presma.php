                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <form class="form-horizontal" method="post" action="/admin/save_presma" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                    <textarea class="form-control" rows="5" id="visi" name="visi"></textarea>
