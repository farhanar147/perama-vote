                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <form class="form-horizontal" method="post" action="/admin/save">
                            <?= csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                    <select class="form-control" name ="hima">
                                        <option value="himakom">HIMAKOM</option>
                                        <option value="hikom">HIKOM</option>
                                        <option value="himen">HIMEN</option>
                                        <option value="himak">HIMAK</option>
